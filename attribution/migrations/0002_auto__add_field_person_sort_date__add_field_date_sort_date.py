...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.sort_date'
        db.add_column(u'attribution_person', 'sort_date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Date.sort_date'
        db.add_column(u'attribution_date', 'sort_date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.sort_date'
        db.delete_column(u'attribution_person', 'sort_date')

        # Deleting field 'Date.sort_date'
        db.delete_column(u'attribution_date', 'sort_date')
    ...
    models = {
        u'attribution.date': {
            ...
            'sort_date': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'})
        },
